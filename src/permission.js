...
const whiteList = ['login', 'register', 'registerResult','dplogin','firstdp'] // no redirect whitelist
...
//   if (to.path === '/') {
//     next({path: '/user/ddShow', query: {redirect: to.fullPath}})
//   }
//   if (to.path === '/user/ddShow') {
//   // if (to.path === '/dp/first') {
//     next()
//     NProgress.done()
//   } else {
...
//   //     next()
//   //   } else {
//   //     next({ path: '/dp/firstdp', query: { redirect: to.fullPath } })
